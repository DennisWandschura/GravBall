...
QT_MOC_LITERAL(4, 46, 18), // "onUpdateController"
QT_MOC_LITERAL(5, 65, 14), // "onSelectEntity"
QT_MOC_LITERAL(6, 80, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(7, 97, 12), // "onActionExit"
QT_MOC_LITERAL(8, 110, 12) // "onActionSave"

    },
    "LevelEditor\0onUpdatePosition\0\0"
    "onUpdateHalfDim\0onUpdateController\0"
...
void LevelEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onUpdateController(); break;
        case 3: _t->onSelectEntity((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: _t->onActionExit(); break;
        case 5: _t->onActionSave(); break;
        default: ;
        }
    }
}
